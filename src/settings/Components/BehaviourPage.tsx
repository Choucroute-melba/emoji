    ...
    return (
        <>
            ...
            <div className={"emojiUsageList"}>
                {
                    usageData.size === 0 ? <p className={"placeholder"}>No usage data yet</p> : Array.from(usageData.entries()).map(([emoji, data]) => {
            ...
            {
                (disabledSites.length > 0) && <h3>Sites where autocomplete is disabled : </h3>
            }
